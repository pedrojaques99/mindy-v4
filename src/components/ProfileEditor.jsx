...
const ProfileEditor = () => {
  const { user, profile, updateUserProfile, profileLoading } = useUser();
    ...
    <div className="bg-dark-400 rounded-lg p-6">
      {!isEditing ? (
        ...
        <form onSubmit={handleSubmit} className="max-w-md mx-auto">
          <h3 className="text-xl font-medium mb-6 text-center">Edit Profile</h3>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full p-2 rounded-md bg-dark-500 border border-dark-300 text-white"
            />
          </div>
          
          <div className="mb-6">
            <label className="block mb-2 text-sm font-medium">Choose Avatar</label>
            <div className="flex justify-center gap-4 mb-4">
              {avatarPreviews.map((avatar) => (
                <div 
                  key={avatar.type}
                  onClick={() => handleAvatarSelect(avatar.type)}
                  className={`w-20 h-20 rounded-full overflow-hidden cursor-pointer border-2 transition-all ${
                    formData.avatar_type === avatar.type ? 'border-lime-accent scale-110' : 'border-dark-300 opacity-60 hover:opacity-100'
                  }`}
                >
                  <img 
                    src={avatar.url} 
          ...
          <div className="mb-6">
            <label className="block mb-2 text-sm font-medium">Social Media Links</label>
            
            <div className="space-y-4">
              <div className="flex items-center">
                <span className="w-24 text-sm text-white/60">Behance</span>
                <input
                  type="url"
                  name="behance_url"
                  ...
                  className="flex-1 p-2 rounded-md bg-dark-500 border border-dark-300 text-white text-sm"
                />
              </div>
              
              <div className="flex items-center">
                <span className="w-24 text-sm text-white/60">Instagram</span>
                <input
                  type="url"
                  name="instagram_url"
              ...
              <div className="flex items-center">
                <span className="w-24 text-sm text-white/60">Twitter/X</span>
                <input
                  type="url"
                  name="twitter_url"
              ...
              <div className="flex items-center">
                <span className="w-24 text-sm text-white/60">LinkedIn</span>
                <input
                  type="url"
                  name="linkedin_url"
              ...
              <div className="flex items-center">
                <span className="w-24 text-sm text-white/60">GitHub</span>
                <input
                  type="url"
                  name="github_url"
